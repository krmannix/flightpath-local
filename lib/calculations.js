...
function calculateClosestApproach(houseLat, houseLon, aircraftLat, aircraftLon, heading, speedKnots) {
  const currentDistance = calculateDistance(houseLat, houseLon, aircraftLat, aircraftLon);
  ...
  const timeToClosestHours = currentDistance / speedMph * Math.cos(approachAngleRad);
